...
export default function Page({ searchParams }: { searchParams: Promise<{ q?: string }> }) { return <PageShell><PageHeader title="Материалы" description="Учебные материалы от преподавателя."/><PageContent><Suspense fallback={<PageContentLoading label="Загружаем материалы"/>}><MaterialsContent searchParams={searchParams}/></Suspense></PageContent></PageShell>; }
