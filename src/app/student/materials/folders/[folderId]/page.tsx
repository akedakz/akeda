...
export default function Page(props: { params: Promise<{ folderId: string }>; searchParams: Promise<{ q?: string }> }) { return <PageShell><PageHeader title="Материалы" description="Учебные материалы от преподавателя."/><PageContent><Suspense fallback={<PageContentLoading label="Загружаем папку"/>}><FolderContent {...props}/></Suspense></PageContent></PageShell>; }
